...
<?php include("../Public/PHP/edit_Account.php") ?>
     <div class="container-fluid">
      ...
      <div class="form-group">
        <label for="inputAreaCode3" class="col-sm-2 control-label">Area Code</label>
        <div class="col-sm-10">
          <input type="number" name="area_code"class="form-control" id="inputAreaCode3" placeholder="Area Code" value="<?php echo $area_code; ?>">
        </div>
      </div>
      <div class="form-group">
