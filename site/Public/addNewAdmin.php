...
<?php include("../Public/PHP/create_Account.php") ?>
     <div class="container-fluid">
      ...
      <div class="form-group">
        <label for="inputAdminId3" class="col-sm-2 control-label">Admin ID</label>
        <div class="col-sm-10">
          <input type="number" name="admin_id" class="form-control" id="inputAdminId3" placeholder="Admin ID" value="<?php echo $admin_id; ?>">
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          <button type="submit"name="adminSubmit" class="btn btn-default">Create Account</button>
